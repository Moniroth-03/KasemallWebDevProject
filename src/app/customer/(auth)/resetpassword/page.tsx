    ...
    <section className="h-screen bg-Bg ">
      <div className=" bg-white rounded-3xl max-w-2xl mx-auto">
        ...
        <p className="font-medium text-gray-800 mx-16 text-center">
          Reset your account{" "}
          <strong className="break-words font bold">Customer</strong> password
          and access your
        </p>
        ...
        <div className="flex flex-col mb-2 relative">
          <label
            htmlFor="password"
            className="mb-3 mt-7 mx-5 px-3 font-medium text-gray-600"
          >
            Password
          </label>
          <div className="mx-8 mb-2 relative flex items-center space-x-4">
            ...
            <button
              ...
              className="absolute right-16 text-navBg text-lg focus:outline-none"
            >
              {showPassword ? (
        ...
        <div className="space-x-2 mt-8 flex items-center justify-center gap-4">
          <button
            ...
            onClick={() => router.push("/customer/verifycode")}
          >
            Back
          </button>
          <button
